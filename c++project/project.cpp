...

    {
        ...
        if(strcmp(password, "abcd")==0){
            ...
            do{
                ...
                cout<<endl<<"I am chotu how can i help you"<<endl<<endl;



                string phrase = "I am chotu how can i help you";
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant chotu created by my masters Pranav and shivansh !!!"<<endl;

                    string phrase = "I am a virtual assistant chotu created by my masters Pranav and shivansh";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                ...
                else if(strcmp(ch, "open jaypee") == 0){

                    cout<<"openining jaypee....."<<endl;

                    string phrase = "opening jaypee";
                    ...
                    system("start https://www.juit.ac.in/m");
